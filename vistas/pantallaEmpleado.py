...
class empleadoView:
    ...
    def pantallaEmpleado(self):
        ...
        self.updateButton.grid(row=0, column=0, padx=10, pady=10, sticky='ew')
        
        self.eliminarButton = tk.Button(buttonFrame, text="Eliminar", bg="#D3D4D4", font=('Arial', 16), command=self.abrirPantallaEliminar)
        self.eliminarButton.grid(row=0, column=1, padx=10, pady=10, sticky='ew')
        ...
        self.eliminarTodoButton.grid(row=0, column=2, padx=10, pady=10, sticky='ew')
